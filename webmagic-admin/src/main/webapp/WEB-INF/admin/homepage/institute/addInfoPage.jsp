...
<body>
  <div class="layui-card-body" pad15="">
    <form action="/homepage/institute/info/add" method="post" enctype="multipart/form-data">
      <div class="layui-form" wid100="" lay-filter="">
        <div class="layui-form-item">
          <label class="layui-form-label">资讯标题</label>
          <div class="layui-input-block">
            <input type="text" name="title" lay-verify="title" lay-verify="required" autocomplete="off" placeholder="请输入标题" class="layui-input">
          </div>
        </div>
        <div class="layui-form-item" style="display: inline-flex;align-items: center;justify-content: flex-start;">
          ...
          <input type="file" name="avatar" id="J_image" style="display: none;">
          <div class="layui-input-inline" style="width: 155px;">
            <img class="layui-upload-img" id="demo1" style="width:150px;height:120px;" src="/images/news/3.jpg">
          </div>
