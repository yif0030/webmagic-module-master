      ...
      <div class="layui-form" wid100="" lay-filter="">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="name" value="${entity.name}" lay-verify="required" class="layui-input">
          </div>
        </div>
        <div class="layui-form-item">
          <label class="layui-form-label">专业1</label>
          <div class="layui-input-block">
            <input type="text" name="major1" value="${entity.major1}" class="layui-input">
          </div>
        </div>
        <div class="layui-form-item">
          <label class="layui-form-label">专业2</label>
          <div class="layui-input-block">
            <input type="text" name="major2" value="${entity.major2}" class="layui-input">
          </div>
        </div>
        <div class="layui-form-item">
          <label class="layui-form-label">学院</label>
          <div class="layui-input-block">
            <input type="text" name="institute" value="${entity.institute}" class="layui-input">
          </div>
        </div>
        <%--<div class="layui-form-item">
